			...
			<div class="row">
				...
				<form class="form form-default" action="controller.do" method="get">
					<div class="row">
						...
						<div class="form-group">
						<label>População:</label> 	<input class="form-control" type="text" name="populacao"><br>
						</div>
						
						<div class="form-group">
						<label>Area:</label> 		<input class="form-control" type="text" name="area"><br>
						</div>
						<button class="btn btn-default btn-warning" type="submit" name="command" value="AlterarPais">ALTERAR</button>
					</div>
